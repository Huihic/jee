...
import com.dbaa.entity.Activity;
import com.dbaa.entity.Confirm;
import com.dbaa.entity.User;
import com.dbaa.service.UserService;
...
public class UserController {
    ...
    @RequestMapping(path = "/userloginIn", method = RequestMethod.POST)
...
//        return "index";
    ...
    public String joinAct(String u_name, String u_email, String act_name, String act_time, String act_location, String actbasicmoney) {
        ...
        //发送者
        mainMessage.setFrom("3399831059@qq.com");
        //接收者
